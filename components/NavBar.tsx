...
import { CalendarDays, User, LogOut, Menu, Calendar, Search, Ticket } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/#ticketing" className="flex items-center gap-2 hover:text-festival-ocre transition-colors">
              <Ticket size={18} />
              Billetterie
            </Link>
              ...
              {session ? (
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="p-2 rounded-full transition text-festival-beige hover:cursor-pointer hover:bg-[var(--primary)]"
      ...
      {isMobileMenuOpen && (
          <div className="md:hidden  bg-black border-t border-green-800">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link 
                href="/programme" 
                className="flex items-center gap-2 px-3 py-2 rounded-md hover:transition"
            ...
            <div className="border-t border-green-800 mt-2 pt-2">
              {session ? (
                <button
                  onClick={() => signOut()}
                  className="w-full text-left block px-3 py-2 rounded-md text-red-300"
                >
                  Se déconnecter
                </button>
              ) : (
